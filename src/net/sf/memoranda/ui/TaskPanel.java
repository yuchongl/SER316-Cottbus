...
public class TaskPanel extends JPanel {
  ...
  void jbInit() throws Exception {
    ...
    newTaskB.setIcon(new ImageIcon(
        net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/todo_new.png")));
    ...
    subTaskB.setIcon(new ImageIcon(
        net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/todo_new_sub.png")));
    ...
    editTaskB.setIcon(new ImageIcon(
        net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/todo_edit.png")));
    ...
    removeTaskB.setIcon(new ImageIcon(
        net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/todo_remove.png")));
    ...
    completeTaskB.setIcon(new ImageIcon(
        net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/todo_complete.png")));
    ...
    /*
     * showActiveOnly.setPreferredSize(new Dimension(24, 24));
     * showActiveOnly.setRequestFocusEnabled(false); if (taskTable.isShowActiveOnly()) {
     * showActiveOnly.setToolTipText(Local.getString("Show All")); } else {
     * showActiveOnly.setToolTipText(Local.getString("Show Active Only")); }
     * showActiveOnly.setMinimumSize(new Dimension(24, 24)); showActiveOnly.setMaximumSize(new
     * Dimension(24, 24)); showActiveOnly.setIcon( new
     * ImageIcon(net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/todo_active.png")))
     * ;
     */
    // added by rawsushi
    ...
    ppEditTask.setIcon(new ImageIcon(
        net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/todo_edit.png")));
    ...
    ppRemoveTask.setIcon(new ImageIcon(
        net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/todo_remove.png")));
    ...
    ppNewTask.setIcon(new ImageIcon(
        net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/todo_new.png")));
    ...
    ppAddSubTask.setIcon(new ImageIcon(
        net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/todo_new_sub.png")));

    /*
     * ppSubTasks.setFont(new java.awt.Font("Dialog", 1, 11)); ppSubTasks.setText(Local.getString(
     * "List sub tasks")); ppSubTasks.addActionListener(new java.awt.event.ActionListener() { public
     * void actionPerformed(ActionEvent e) { ppListSubTasks_actionPerformed(e); } });
     * ppSubTasks.setIcon(new
     * ImageIcon(net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/todo_new.png")));
     * 
     * ppParentTask.setFont(new java.awt.Font("Dialog", 1, 11));
     * ppParentTask.setText(Local.getString("Parent Task")); ppParentTask.addActionListener(new
    ...
    ppCompleteTask.setIcon(new ImageIcon(
        net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/todo_complete.png")));
    ...
    ppCalcTask.setIcon(new ImageIcon(
        net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/todo_complete.png")));
    ...
    taskTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
      public void valueChanged(ListSelectionEvent ev) {
        ...
        // ppSubTasks.setEnabled(enbl); // default value to be over-written later depending on
        // whether it has sub tasks
        ppCalcTask.setEnabled(enbl); // default value to be over-written later depending on whether
                                     // it has sub tasks

        /*
         * if (taskTable.getCurrentRootTask() == null) { ppParentTask.setEnabled(false); } else {
  ...
  void addSubTask_actionPerformed(ActionEvent ev) {
    TaskDialog dlg = new TaskDialog(App.getFrame(), Local.getString("New Task"));
    String parentTaskId = taskTable.getModel().getValueAt(
        taskTable.getSelectedRow(), TaskTable.TASK_ID).toString();
  ...
  void parentTask_actionPerformed(ActionEvent ev) {
    ...
    /*
     * Task t2 = CurrentProject.getTaskList().getTask(taskTable.getCurrentRootTask());
     * 
     * String parentTaskId = t2.getParent(); if((parentTaskId == null) || (parentTaskId.equals("")))
     * { parentTaskId = null; } taskTable.setCurrentRootTask(parentTaskId);
     * taskTable.tableChanged();
     */
