				...
				if (e.getEventType() == HyperlinkEvent.EventType.ACTIVATED) {
					...
					if (d.equalsIgnoreCase("memoranda:events"))
						...
						if (!dlg.CANCELLED) {
						 ...
						 String name = JOptionPane.showInputDialog(parent,Local.getString("Enter the file name to export"),null);
						...
						final JFrame parent = new JFrame();
						String name = JOptionPane.showInputDialog(parent,Local.getString("Enter the file name to import"),null);
