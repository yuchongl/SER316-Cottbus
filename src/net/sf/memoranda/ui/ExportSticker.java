...
/*                        _doc = new Document(_root);
        ...
        public boolean export(String src){
                ...
                File file = new File(this.name+"."+src);
                        ...
                        fwrite.close();
                        JOptionPane.showMessageDialog(null,Local.getString("Document created successfully in your folder Memo = D"));
            
            
        } catch (IOException e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,Local.getString("NO We were able to create your document =(..."));
        }
