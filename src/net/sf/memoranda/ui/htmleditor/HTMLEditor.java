...
public class HTMLEditor extends JPanel {
	...
	void jbInit() throws Exception {
		...
		stylePasteAction.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_V,
		...
		underAction.putValue(Action.ACCELERATOR_KEY,
		 ...
		 * boldAction); editor.getKeymap().addActionForKeyStroke(
		 * KeyStroke.getKeyStroke(KeyEvent.VK_I,
		 * Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()), italicAction);
		 * editor.getKeymap().addActionForKeyStroke(
		 ...
		 * undoAction); editor.getKeymap().addActionForKeyStroke(
		...
		editor.getKeymap().addActionForKeyStroke(
				KeyStroke.getKeyStroke(KeyEvent.VK_V, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()),
				pasteAction);
		editor.getKeymap().addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_V,
				Toolkit.getDefaultToolkit().getMenuShortcutKeyMask() + KeyEvent.SHIFT_MASK), stylePasteAction);
		editor.getKeymap().addActionForKeyStroke(
				KeyStroke.getKeyStroke(KeyEvent.VK_X, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()), cutAction);
		 ...
		 * Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()), zoomInAction);
		 * editor.getKeymap().addActionForKeyStroke(
		 ...
		 * Toolkit.getDefaultToolkit().getMenuShortcutKeyMask() +
		 * KeyEvent.SHIFT_MASK)); jMenuItemRedo.setIcon( new
		 * ImageIcon(net.sf.memoranda.ui.htmleditor.AppFrame.class.getResource(
