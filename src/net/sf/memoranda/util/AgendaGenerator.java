	...
	static String generateStickers(CalendarDate date) {
		...
		while (!pQ.Vacia()) {
			...
			s += "\n<table border=\"0\" cellpadding=\"0\" width=\"100%\"><table width=\"100%\"><tr bgcolor=\"#E0E0E0\"><td><a href=\"memoranda:editsticker#"
					...
					+ "</a></td><td width=\"80%\"><a href=\"memoranda:expandsticker#" + id + "\">"
					+ Local.getString("OPEN IN A NEW WINDOW") 
					+"<a href=\"memoranda:priorityUpSticker#" + id
					+ "\"><img align=\"left\" width=\"15\" height=\"15\" src=\"" + arrowUP 
					+ "\" border=\"0\"  hspace=\"10\" vspace=\"0\" alt=\"Priority Up\">"
					+"<a href=\"memoranda:priorityDownSticker#" + id
					+ "\"><img align=\"left\" width=\"15\" height=\"15\" src=\"" + arrowDown
					+ "\" border=\"0\"  hspace=\"10\" vspace=\"0\" alt=\"Priority Down\">"
					+ "<a href=\"memoranda:removesticker#" + id
					+ "\"><img align=\"right\" width=\"15\" height=\"15\" src=\"" + iurl2
					+ "\" border=\"0\"  hspace=\"15\" vspace=\"0\" alt=\"Remove sticker\"></a></td></table></tr><tr><td>"
					+ txt + "</td></tr></table>";
		}
		s += "<hr>";
		return s;
